...
const projects = [
  ...
  {
    name: "CNN Handwritten Digits Recognition Model",
    description:
      "This project implements a Convolutional Neural Network (CNN) model for handwritten digits recognition, achieving 98.8% accuracy on the MNIST dataset",
    stack: ["Keras", "Seaborn", "Matplotlib"],
    category: "Machine Learning",
    sourceCode: "https://github.com/Juin28/Handwritten_Digits_Recognition_Model",
  },
  {
    name: "Tenzies Game App",
    description:
      "The Tenzies game app is a simple yet addictive dice game that challenges players to roll the same number on all 10 dice and the objective is to be the first to achieve this goal",
    stack: ["React.js", "CSS3", "HTML5"],
    category: "Web Development",
    sourceCode: "https://github.com/Juin28/Tenzies_Game_App",
    livePreview: "https://juin.is-a.dev/Tenzies_Game_App/",
  },
  {
    name: "Notes App",
    description:
      "Notes App is a React-based note-taking application that leverages Firebase's real-time database to provide a seamless, cross-device experience. Users can create, edit, and manage personal notes, with features like search, tags, and real-time synchronization",
  ...
  },
  {
    ...
    description:
      "A meme generator allows users to create shareable memes by adding custom text to existing images",
    stack: ["React.js", "CSS3", "HTML5"],
    category: "Web Development",
    sourceCode: "https://github.com/Juin28/Tenzies_Game_App",
    livePreview: "https://juin.is-a.dev/Meme_Generator/",
  },
]
